...
class SimulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create simulation" do
    assert_difference('Simulation.count') do
      post simulations_url, params: { simulation: { description: @simulation.description, name: @simulation.name, project_id: @simulation.project_id } }
    end
  ...
  test "should update simulation" do
    patch simulation_url(@simulation), params: { simulation: { description: @simulation.description, name: @simulation.name, project_id: @simulation.project_id } }
